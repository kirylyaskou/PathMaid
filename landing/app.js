...
const STRINGS = {
  en: {
    ...
    'cloud.eyebrow': 'Now with cloud sync',
    'cloud.title': 'Your campaign follows every device.',
    'cloud.body': 'Sign in once and keep campaigns, encounters, custom creatures, notes, and uploaded images synchronized across your desktop installs. Prep on one machine, run on another, and keep going when the internet drops.',
    'cloud.local.title': 'Offline first',
    'cloud.local.body': 'Local data stays on your machine and sync catches up when the connection returns.',
    'cloud.assets.title': 'Images included',
    'cloud.assets.body': 'Campaign artwork and handouts travel with the campaign, not just database rows.',
    'cloud.devices.title': 'One GM, many desks',
    'cloud.devices.body': 'Move between Windows, macOS, and Linux without rebuilding the same workspace.',
  ...
  ru: {
    ...
    'cloud.eyebrow': 'Теперь с облачной синхронизацией',
    'cloud.title': 'Кампания переезжает между устройствами.',
    'cloud.body': 'Войдите в аккаунт, и кампании, энкаунтеры, кастомные существа, заметки и загруженные изображения будут синхронизироваться между вашими установками PathMaid. Готовьтесь на одном компьютере, ведите игру на другом и продолжайте работать офлайн.',
    'cloud.local.title': 'Сначала локально',
    'cloud.local.body': 'Данные остаются на устройстве, а синхронизация догоняет изменения, когда интернет возвращается.',
    'cloud.assets.title': 'Изображения тоже',
    'cloud.assets.body': 'Арты кампании и раздаточные материалы едут вместе с кампанией, а не только строки базы.',
    'cloud.devices.title': 'Один мастер, несколько столов',
    'cloud.devices.body': 'Переключайтесь между Windows, macOS и Linux без ручного восстановления рабочего пространства.',
